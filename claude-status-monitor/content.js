(() => {
  ...
  badge.innerHTML = `<span class="dot" style="background:#6b7280"></span><span class="badge-label">載入中…</span>`;
  ...
  panel.innerHTML = `
    <div class="panel-header">
      <div class="panel-header-left">
        <span class="dot" style="width:8px;height:8px;background:#6b7280"></span>
